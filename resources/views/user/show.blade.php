    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="col-span-2">
            <span class="flex rounded-md justify-center mb-10" role="group">
                ...
                <a href="{{ route('user.certificate', ['Profile' => $user]) }}" class="px-4 py-2 text-xl font-semibold text-gray-900 bg-transparent border border-gray-900 rounded-r-md hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white">
                    ได้รับเกียรติบัตร
                </a>
            </span>
