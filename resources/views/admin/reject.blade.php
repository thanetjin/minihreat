    ...
    <div class="col-span-2 block p-8 bg-white border border-gray-200 rounded-lg shadow h-full">
        <form action="{{ route('admin.reason', ['event' => $event]) }}" method="POST">
            ...
            <div class="flex justify-end">
                <button type="submit" class="flex py-1 px-5 mr-3 mb-2 text-md font-semibold text-white bg-red-500 rounded-lg border border-gray-900  bg-red-500 hover:bg-white hover:text-black my-10 ">
