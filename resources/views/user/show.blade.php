        ...
        <div class="col-span-2">
            ...
            {{-- @if($->count() > 0) --}}
                <div class="overflow-y-scroll h-[88vh]">
                    @for ($i = 0;$i < 2;$i++)
                    <div class="mb-5 mx-auto flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl">
                        <img class="h-fit w-full rounded-t-lg h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="{{ URL('images/background-user.jpg') }}" alt="images for event">
